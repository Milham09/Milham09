            ...
            <div class="col-lg-10">
                <div class="card-item single-card">
                    ...
                    <div class="card-content">
                        <h2 class="card-title font-size-25 mb-3" style="text-align: center ;"><?= $news['judul']; ?></h2>
                        <div class="card-image after-none">
                        <div class="single-slider owl-trigger-action owl-trigger-action-3">
                        <figure class="figure">
                            <img src="<?= base_url(); ?>/img/<?= $news['foto']; ?>" class="figure-img img-fluid rounded" alt="...">
                        </figure>
                        </div>
                    </div><!-- end card-image -->
                        ...
                        <div>
                            <a href="<?= base_url(); ?>/list" class="btn btn-primary mt-3">Kembali</a>
                        </div>
